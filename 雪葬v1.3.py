...
from PyQt5.QtGui import QIcon, QFont, QPalette, QColor, QMovie, QBrush, QPen, QLinearGradient, QPainter  # 添加 QPainter
...
class ResourceChart(QGraphicsView):
    def __init__(self, parent=None):
        ...
        self.setRenderHint(QPainter.Antialiasing) # 这里使用了 QPainter
        self.data = []
        self.max_items = 30
