...
from PyQt5.QtGui import QIcon, QFont, QPalette, QColor, QMovie, QBrush, QPen
    ...
    def get_process_description(self, pid):
        ...
        try:
            ...
            try:
                ...
                if ctypes.windll.psapi.GetModuleFileNameExW(ctypes.c_void_p(int(hProcess)), None, exe_path, size) == 0:
                    return "无法获取文件路径"
