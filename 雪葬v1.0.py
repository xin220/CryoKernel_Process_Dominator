import sys
import ctypes  # 确保在管理员权限检查之前导入ctypes
import warnings
import time
import winreg
import win32api
...
class SnowBurial(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("雪葬 - 进程冻结工具 v1.0")
    ...
    def get_process_list(self):
        ...
        try:
            ...
            while True:
                ...
                name = pe32.szExeFile.decode('latin1', errors='replace')  # 解码进程名，处理异常字符
